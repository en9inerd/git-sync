...
if [ ! -f "$NETRC_FILE" ]; then
    log ERROR "~/.netrc not found! Create it with your GitHub token:"
    log ERROR "machine github.com login YOUR_GITHUB_USERNAME password YOUR_GITHUB_TOKEN"
    log ERROR "machine api.github.com login YOUR_GITHUB_USERNAME password YOUR_GITHUB_TOKEN"
    exit 1
fi
...
log INFO "Detected GitHub username: $GITHUB_USER"
...
log INFO "Fetching personal repositories..."
...
log DONE "All repositories synced successfully."
